...
Use a [Service](/services/introduction) instead when you need a Docker Compose topology, multiple database containers, an unsupported engine, or configuration that the one-click database form does not expose.
