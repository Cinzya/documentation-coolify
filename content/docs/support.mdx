...
<ZoomImage src="/docs/images/support-banner.webp" alt="Coolify support banner" />
...
While the community does provide some help, the [Core team](/team) is actively involved in the forum to ensure questions are addressed.
