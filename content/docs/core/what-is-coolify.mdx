...
For a detailed breakdown, see [Self-hosted vs Coolify Cloud](/core/selfhosted-cloud-comparison).


## Next reads
If you are new, these pages are the best follow-up:
- [How Coolify works](/core/how-coolify-works)
- [Docker and Containers](/core/docker-and-containers)
- [Networking in Coolify](/core/networking-in-coolify)
- [Build and deployment model](/core/build-deployment-model)
