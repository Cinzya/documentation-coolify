...
Enable **Connect To Predefined Network** when a Docker Compose resource must communicate with other resources through its Coolify destination. Review [Docker Compose networking](/knowledge-base/docker/compose#connect-to-predefined-networks) before enabling the setting.
