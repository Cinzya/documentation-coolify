...
Enable **Connect To Predefined Network** in the resource settings when its containers must join the selected destination and communicate with other resources on that Docker network. Read [Docker Compose networking](/knowledge-base/docker/compose#connect-to-predefined-networks) for the Compose requirements and limitations.
