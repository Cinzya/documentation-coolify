...
Preview deployments can generate additional subdomains from the application's preview URL template. Make sure the DNS records cover those names before relying on the generated preview URLs. See [Preview Deployments](/applications/ci-cd/github/preview-deploy) for the preview-specific setup.
