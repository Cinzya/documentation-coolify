...
Read [API Authorization](/api-reference/authorization) for the request format, base URL, status codes, and rate limits. For deployment-only automation, follow [Deploy Webhooks](/core/automation/deploy-webhooks).
