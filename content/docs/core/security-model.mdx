...
Coolify's automated SSH connection must work without an interactive prompt. Follow the [OpenSSH guide](/core/servers/openssh) when configuring the server account and key.
  ...
  groups={[
    {
      ...
      links: [
        ...
        { title: 'Terminal access', href: '/core/servers/web-terminal' },
      ],
    },
    {
      ...
      icon: Server,
      links: [
        { title: 'OpenSSH', href: '/core/servers/openssh' },
