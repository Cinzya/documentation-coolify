...
Read [Persistent Storage](/knowledge-base/persistent-storage) to configure volumes and bind mounts in Coolify. Docker’s [storage guide](https://docs.docker.com/get-started/docker-concepts/running-containers/persisting-container-data/) explains the underlying model.
...
<CoolNextSteps
  cards={[
    ...
    {
      title: 'Persistent Storage',
      href: '/knowledge-base/persistent-storage',
      description: 'Configure a named volume or bind mount for data that must survive container replacement.',
      icon: HardDrive,
    },
  ]}
/>
