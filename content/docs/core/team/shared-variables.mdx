...
Follow [Shared Environment Variables in Docker Compose](/knowledge-base/docker/compose#shared-environment-variables) for the supported patterns and examples.
