...
All features are the same in both, Cloud just saves you from managing Coolify by yourself. Learn more in our [Self-hosted vs Coolify Cloud comparison](/core/selfhosted-cloud-comparison).
