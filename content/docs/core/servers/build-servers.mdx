...
Complete [Create and authorize an SSH key](/core/servers/add-server#create-and-authorize-an-ssh-key) before opening the server form.
...
3. Select **+ Add**.
4. Find **Add Server by IP Address**.
...
<ZoomImage src="/docs/images/core/infrastructure/servers/build-servers/new-server-build-setting.webp" alt="New Server form with the build server setting enabled" />
...
3. Select **Resources**.
4. Select **Managed**.
5. Confirm that the page says **No managed resources found**.
