...
Follow [Add Server](/core/servers/add-server#connect-the-server-to-coolify) to connect and validate the server.
...
- Check the [OpenSSH](/core/servers/openssh) settings and [firewall](/core/servers/firewall) rule for the SSH port.
