...
Authenticate the configured server user to the registry on the manager and worker nodes. See [Docker Registry](/knowledge-base/docker/registry#docker-credentials).
