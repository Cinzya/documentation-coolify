...
If the server does not have a public IP address, or you do not want to expose SSH publicly, connect it through [Server SSH Access via Cloudflare Tunnels](/integrations/cloudflare/tunnels/server-ssh).
