...
The inspection output includes Docker's server-side mountpoint. Avoid editing files inside Docker's internal volume directory while the application is running. Use the application's supported backup method, or stop writes before copying volume data.
