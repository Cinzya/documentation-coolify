...
For safer testing, allow the port only from your own IP address and close it again when you are done. For general guidance, see [Firewall](/core/servers/firewall).
