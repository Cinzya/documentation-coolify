...
import { ArrowsRight, Box2, Camera, Globe3, Rocket2, SignalStream, Warning22 } from 'reicon-react';
...
<CoolCallout className="my-5" id="apps-run-as-containers" icon={Box2} title="Apps run as containers">
