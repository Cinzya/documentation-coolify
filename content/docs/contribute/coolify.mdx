...
To add a new service to Coolify, please refer to our documentation: [Adding a New Service](/contribute/service)

### Contributing to Documentation

To contribute to the Coolify documentation, please refer to this guide: [Contributing to the Coolify Documentation](/contribute/documentation)
