...
<CoolCallout id="startup-note" icon={Warning22} title="Startup note" type="warn">
...
<CoolCallout id="draft-pull-requests" icon={Warning22} title="Draft pull requests" type="warn">
...
<CoolCallout id="reset-development-environment" icon={Warning22} title="Reset development environment" type="warn">
