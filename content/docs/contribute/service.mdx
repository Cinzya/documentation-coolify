...
<CoolCallout id="eligibility" icon={Warning22} title="Eligibility" type="warn">
...
<CoolFlow
  ...
  list={[
    'Read the [Docker Compose magic variables guide](/docs/knowledge-base/docker/compose#coolifys-magic-environment-variables).',
...
<CoolCallout id="port-note" icon={Warning22} title="Port note" type="warn">
...
<CoolCallout id="logo-and-test" icon={Image} title="Logo and testing" contentClassName="!p-0">
<CoolPanel>
