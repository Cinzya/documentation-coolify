...
<CoolCallout id="important" icon={Warning22} title="Important" type="warn">
...
<CoolCallout id="ways-to-contribute" icon={MessageQuestion2} title="Ways to contribute">
...
<CoolTable
  className="my-0"
  columns={[
    { header: 'Prefix', icon: Checklist2 },
    { header: 'Use', icon: DocumentText2 },
  ]}
  rows={[
