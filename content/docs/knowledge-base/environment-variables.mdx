...
description: "Manage build-time and runtime environment variables in Coolify with team, project, environment, and server-scoped shared variables plus predefined system values."
---
...
Shared variables let you define a value at team, project, environment, or server scope and reference it from resource configuration.

Follow [Shared Variables](/core/team/shared-variables) to choose a scope, create a value, use reference syntax such as `{{team.NODE_ENV}}`, and manage variables in Normal or Developer view.

For Docker Compose placement and examples, see [Shared Environment Variables in Docker Compose](/knowledge-base/docker/compose#shared-environment-variables).
