...
Both update frequencies use cron syntax for scheduling. For detailed information about the supported cron syntax, see [Cron Syntax](/core/automation/cron-syntax).
