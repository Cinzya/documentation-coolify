...
1. Create your shared variable following the [Shared Variables guide](/core/team/shared-variables).
...
It uses a compose file deploying Appwrite on the [wildcard](/core/infrastructure/servers/add-server#set-a-wildcard-domain-optional) domain `http://example.com` .
