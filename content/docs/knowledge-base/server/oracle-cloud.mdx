...
- All configuration is set for sudo. Details [here](/core/infrastructure/servers/non-root-user).
...
For more details, check [this](/core/infrastructure/servers/firewall) page.