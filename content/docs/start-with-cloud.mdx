...
| [3. Server resources for your projects](#3-server-resources-for-your-projects) | Confirm your servers have enough CPU, memory, and storage for your workloads. |
| [4. Server access requirements](#4-server-access-requirements) | Confirm SSH access, Docker support, and firewall rules are ready. |
| [5. Shared responsibility model](#5-shared-responsibility-model) | Confirm who is responsible for the control plane, servers, workloads, and backups. |
| [6. Subscription and server limits](#6-subscription-and-server-limits) | Confirm your plan supports the number of servers you want to connect. |
