...
Because this resource has no Git source, repository webhooks and pull-request previews do not apply. Read [Services](/services/introduction) for the user-defined Service lifecycle.
