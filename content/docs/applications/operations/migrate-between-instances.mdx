...
For a Coolify-managed database, use [Database backups](/databases/backups) as the starting point. Verify the restore by checking required tables or records before the destination application uses the database.
