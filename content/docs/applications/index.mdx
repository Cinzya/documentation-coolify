...
Building Docker images can be resource-intensive. You can use a dedicated [build server](/core/servers/build-servers) to handle builds separately from your production server.
