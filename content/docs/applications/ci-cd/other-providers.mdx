...
2. Add your repository URL to the input field, for example: `https://git.shadowarcanist.com/username/repository`
...
3. Add your repository URL to the input field, for example: `git@git.shadowarcanist.com:username/repository.git`
...
1. Create a [Coolify API token](/core/security/credentials/api-tokens) in your Coolify dashboard
