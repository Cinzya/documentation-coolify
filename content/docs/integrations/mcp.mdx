...
You can enable it by following the [API token setup](/core/security/credentials/api-tokens) guide.
...
The MCP server uses your existing Coolify API tokens for authentication. Follow the [API Tokens guide](/core/security/credentials/api-tokens) to create a token.
