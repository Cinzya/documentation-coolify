...
<ZoomImage src="/docs/images/integrations/security/cloudflare/overview-diagram.webp" />
...
A simple high-level overview diagram to give you a visual idea of how this works:
<ZoomImage src="/docs/images/integrations/security/cloudflare/cf-origin-certificate-overview-diagram.webp" />

---

## A. Create Cloudflare Origin Certificate [!toc]
<ZoomImage src="/docs/images/integrations/security/cloudflare/1.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/2.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/3.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/8.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/9.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/10.webp" />
...
A simple high-level overview diagram to give you a visual idea of how this works:
<ZoomImage src="/docs/images/integrations/security/cloudflare/public-ca-origin-certificate-overview-diagram.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/4.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/5.webp" />

1. Go to **SSL/TLS** in Cloudflare.
2. Select **Overview**.
3. Click **Configure** button

<ZoomImage src="/docs/images/integrations/security/cloudflare/6.webp" />
...
<ZoomImage src="/docs/images/integrations/security/cloudflare/7.webp" />
