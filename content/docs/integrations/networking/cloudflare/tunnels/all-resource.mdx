...
<ZoomImage src="/docs/images/integrations/networking/cloudflare/tunnels/all-resource/13.webp" />

1. Go to **SSL/TLS** in Cloudflare.
2. Select **Overview**.
3. Click **Configure** button

<ZoomImage src="/docs/images/integrations/networking/cloudflare/tunnels/all-resource/14.webp" />
